...
import { getRiskLimitById } from 'apiSdk/risk-limits';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Risk Limit Detail View
          </Text>
          {hasAccess('risk_limit', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/risk-limits/edit/${data?.id}`} passHref legacyBehavior>
              <Button
